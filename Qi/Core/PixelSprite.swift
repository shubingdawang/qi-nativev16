...
enum ClawdSprites {
    ...
    static let guitar2 = PixelSprite([
        ...
        "..ppppppppkkpppozpzzppkkpppppppp....",
        "..ppppppppkkpppppzzzzpkkoGpppppp....",
        "..pppppppppppppppozzzooooooopppp....",
        "..ppppppppppppppppoooooooooooopp....",
    ...
    static let guitar = PixelSprite([
        ...
        "..ppppppppkkpppzzozoppkkpppppppp....",
        "..ppppppppkkppppozzzopkkpppppppp....",
        "..pppppppppppooppzzzzooooooppppp....",
        "..ppppppppppppppppzooooooooooppp....",
