...
extension FurnitureCatalog {
    ...
    static let drawnArt: [String: Art] = [
        ...
        // 小摆件那一批（照她给的参考屋补的）
        "wallshelf":       Art(flat: "px_wallshelf", iso: "iso_l_px_wallshelf"),
        "bunting":         Art(flat: "px_bunting", iso: "iso_l_px_bunting"),
        "aircon":          Art(flat: "px_aircon", iso: "iso_l_px_aircon"),
        "cakestand":       Art(flat: "px_cakestand", iso: "iso_l_px_cakestand"),
        "perfume":         Art(flat: "px_perfume", iso: "iso_l_px_perfume"),
        "bookstack":       Art(flat: "px_bookstack", iso: "iso_l_px_bookstack"),
        "bunny":           Art(flat: "px_bunny", iso: "iso_l_px_bunny"),
        "ringtoy":         Art(flat: "px_ringtoy", iso: "iso_l_px_ringtoy"),
        "sidetable":       Art(flat: "px_sidetable", iso: "iso_l_px_sidetable"),
        "coffeetable":     Art(flat: "px_coffeetable", iso: "iso_l_px_coffeetable"),
        "trashbin":        Art(flat: "px_trashbin", iso: "iso_l_px_trashbin"),
        "tvstand":         Art(flat: "px_tvstand", iso: "iso_l_px_tvstand"),
