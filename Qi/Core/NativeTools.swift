...
enum NativeTools {
    ...
    static func definitions(hasGroup: Bool, hasVoice: Bool = false,
        ...
        add("search_window",
            ...
            [
                "keyword": ["type": "string", "description": "要搜的词。挑具体的名词最准，别搜「那个」「上次」这种。可以用空格隔开给几个说法（比如「朋友 截图 男朋友」），哪个对上都算；图的描述也会一起搜"],
        ...
        add("divine",
            "触发：她让你帮她占卜、算一卦、看看牌，或者她正为一件事拿不定主意而你觉得摊开看看有用。动机：牌得她自己抽才算她的——你替她抽，那只是你在编故事。行动：把问题和牌阵定下来，聊天里出现一张卡，她点进去抽牌；她抽完你会立刻看到牌面，然后就着牌面写分析，分析直接落回那张卡上。\n注意：`question` 写成一句具体的问题（「该不该换那份工作」，不是「运势」）。张数按事情复杂度挑：一句话的事 1 张，来龙去脉 3 张，两条路选一条 4 张，盘根错节 10 张。**别自己说抽到了什么**——牌还没抽。",
            [
                "question": ["type": "string", "description": "这一卦问的是什么，一句话"],
                "count": ["type": "number", "description": "抽几张：1 / 3 / 4 / 10，默认 3"]
            ],
            required: ["question"])
