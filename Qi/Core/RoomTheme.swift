...
extension RoomTheme {
    ...
    static let all: [RoomTheme] = [
        ...
        .init(id: "forest", label: "林间", note: "苔绿配榻榻米",
              ...
              price: 120),
        // 她给的参考（别人做的粉色 RPG 小屋）：粉条纹墙 + 奶油底紫蝴蝶结地
        .init(id: "pinkroom", label: "粉色小屋", note: "蕾丝腰线粉墙，紫蝴蝶结地毯",
              wall: .lace, floor: .bows,
              wallHexes: ["F2C4CE", "E7AEBB"],
              floorHexes: ["F8ECD8", "F2E3CB", "B49AD8"],
              price: 160),
        .init(id: "ribbon", label: "蝴蝶结", note: "奶白蝴蝶结墙纸配浅木",
              wall: .bows, floor: .wood,
              wallHexes: ["F6E6E9"],
              floorHexes: ["E0C09B", "D6B591", "E8CAA6"],
              price: 140),
