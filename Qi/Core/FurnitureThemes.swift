...
extension FurnitureCatalog {
    ...
    static let themed: [FurnitureKind] = [
        ...
        .init(id: "hoodie", name: "小背带裤", price: 85,
              sprite: sp_small, category: .wear, reaction: "扣好两边的背带"),
        .init(id: "cap", name: "棒球帽", price: 70,
              sprite: sp_small, category: .wear, reaction: "帽檐往后一转"),
        .init(id: "tie", name: "小领带", price: 60,
              sprite: sp_small, category: .wear, reaction: "把领带拉正"),
        .init(id: "sneakers", name: "小球鞋", price: 80,
              sprite: sp_small, category: .wear, reaction: "原地蹦两下"),
        .init(id: "headphones", name: "头戴耳机", price: 110,
              sprite: sp_small, category: .wear, reaction: "跟着节奏点头"),
        .init(id: "plaidshirt", name: "格子衬衫", price: 90,
              sprite: sp_small, category: .wear, reaction: "卷起袖子"),
        .init(id: "sunglasses", name: "小墨镜", price: 75,
              sprite: sp_small, category: .wear, reaction: "推到头顶上"),
        .init(id: "suit", name: "小西装", price: 160,
              sprite: sp_small, category: .wear, reaction: "理了理领口"),
        .init(id: "dress_shoes", name: "小皮鞋", price: 90,
              sprite: sp_small, category: .wear, reaction: "擦得锃亮"),
        .init(id: "tie_black", name: "黑领带", price: 60,
              sprite: sp_small, category: .wear, reaction: "打个温莎结"),
        .init(id: "tie_white", name: "白领带", price: 60,
              sprite: sp_small, category: .wear, reaction: "小心别弄脏"),
        .init(id: "tie_stripe", name: "条纹领带", price: 65,
              sprite: sp_small, category: .wear, reaction: "对着镜子系"),
        .init(id: "tie_dot", name: "波点领带", price: 65,
              sprite: sp_small, category: .wear, reaction: "晃了晃"),
        .init(id: "tie_damask", name: "暗纹领带", price: 70,
              sprite: sp_small, category: .wear, reaction: "摸了摸花纹"),
        // 成套的衣服（照她找的换装参考改成 clawd 体型，scripts/wear_art.py）
        .init(id: "uni_vest", name: "学生马甲装", price: 140,
              sprite: sp_small, category: .wear, reaction: "扯了扯马甲下摆"),
        .init(id: "uni_blazer", name: "藏青学生西装", price: 170,
              sprite: sp_small, category: .wear, reaction: "把校徽擦亮"),
        .init(id: "trench", name: "棕色风衣", price: 190,
              sprite: sp_small, category: .wear, reaction: "系紧腰带"),
        .init(id: "tux", name: "黑色礼服", price: 220,
              sprite: sp_small, category: .wear, reaction: "正了正领结"),
        .init(id: "military", name: "军装外套", price: 200,
              sprite: sp_small, category: .wear, reaction: "站得笔直"),
        .init(id: "blue_shirt", name: "浅蓝衬衫", price: 100,
              sprite: sp_small, category: .wear, reaction: "把领子翻好"),
        .init(id: "white_suit", name: "白西装", price: 210,
              sprite: sp_small, category: .wear, reaction: "小心别蹭脏"),
        .init(id: "stripe_pj", name: "条纹睡衣", price: 90,
              sprite: sp_small, category: .wear, reaction: "打了个哈欠"),
    ...
    static let themedArt: [String: Art] = [
        ...
        "hoodie":         Art(flat: "px_hoodie",                 iso: nil),
        "cap":            Art(flat: "px_cap",                    iso: nil),
        "tie":            Art(flat: "px_tie",                    iso: nil),
        "sneakers":       Art(flat: "px_sneakers",               iso: nil),
        "headphones":     Art(flat: "px_headphones",             iso: nil),
        "plaidshirt":     Art(flat: "px_plaidshirt",             iso: nil),
        "sunglasses":     Art(flat: "px_sunglasses",             iso: nil),
        "suit":           Art(flat: "px_suit",                   iso: nil),
        "dress_shoes":    Art(flat: "px_dress_shoes",            iso: nil),
        "tie_black":      Art(flat: "px_tie_black",              iso: nil),
        "tie_white":      Art(flat: "px_tie_white",              iso: nil),
        "tie_stripe":     Art(flat: "px_tie_stripe",             iso: nil),
        "tie_dot":        Art(flat: "px_tie_dot",                iso: nil),
        "tie_damask":     Art(flat: "px_tie_damask",             iso: nil),
        "uni_vest":       Art(flat: "wear_uni_vest", iso: nil),
        "uni_blazer":     Art(flat: "wear_uni_blazer", iso: nil),
        "trench":         Art(flat: "wear_trench", iso: nil),
        "tux":            Art(flat: "wear_tux", iso: nil),
        "military":       Art(flat: "wear_military", iso: nil),
        "blue_shirt":     Art(flat: "wear_blue_shirt", iso: nil),
        "white_suit":     Art(flat: "wear_white_suit", iso: nil),
        "stripe_pj":      Art(flat: "wear_stripe_pj", iso: nil),
    ...
    static func themedShape(of id: String) -> IsoShape? {
        ...
        case "autumn_pumpkin", "autumn_wreath", "xmas_gifts", "xmas_wreath",
             ...
             "cap", "tie", "sneakers", "headphones", "plaidshirt", "sunglasses",
             "suit", "dress_shoes", "tie_black", "tie_white", "tie_stripe",
             "uni_vest", "uni_blazer", "trench", "tux", "military", "blue_shirt", "white_suit", "stripe_pj",
             "tie_dot", "tie_damask", "xred_trunk", "rose_trunk", "star_trunk",
             "star_gramophone", "star_books":
