    ...
    nonisolated static let groups: [ToolGroup] = [
        ...
        ToolGroup(id: "album", title: "相册与表情",
                  ...
                  tools: ["save_sticker", "save_photo_to_folder", "send_photo_from_folder",
                          ...
                          // ⚠️ `send_photo`（发张表情）**不在这儿**：那是他随口就用的一件，
                          // 摘掉就等于把他的表情收走了。这几件是「翻、找、整理」，才分得开
                          "find_sticker", "list_my_stickers", "list_recent_images", "show_image"],
        ...
        ToolGroup(id: "voice", title: "语音与通话",
                  ...
                  keywords: ["语音", "念", "读给我", "打电话", "通话", "接电话", "唱", "听听", "说给我听"]),
        ToolGroup(id: "files", title: "文件",
                  summary: "看资料库里有什么、读一份、把文件收进文件夹、发文件给她",
                  tools: ["list_library", "library_folder", "read_file", "file_to_folder", "send_file"],
                  keywords: ["文件", "资料", "文档", "读一下", "发给我", "存到", "文件夹", "pdf", "txt", "word"]),
        ToolGroup(id: "promise", title: "承诺",
                  summary: "跟她说定一件事、看还欠着什么、兑现",
                  tools: ["make_promise", "list_promises", "keep_promise"],
                  keywords: ["答应", "承诺", "说好", "保证", "欠我", "说话算话", "别忘了你说"]),
        ToolGroup(id: "divine", title: "占卜",
                  summary: "在聊天里摆一卦，她抽牌、你解读",
                  tools: ["divine"],
                  keywords: ["占卜", "算一卦", "卦", "塔罗", "抽牌", "抽一张", "牌",
                             "运势", "水逆", "命", "测一下", "该不该", "选哪个",
                             "灵不灵", "问问牌"]),
        ...
        ToolGroup(id: "history", title: "聊天记录",
                  ...
                  tools: ["recall_history", "search_transcripts", "get_transcript_context",
                          "update_transcript_summary", "delete_transcript", "search_window"],
